                ...
                <div class="contacts-leadership-grid">
                    ...
                    <article class="contacts-leadership-card">
                        ...
                        <div class="contacts-leadership-card__meta">
                            <?php if (isset($row['phones']) && is_array($row['phones']) && $row['phones'] !== array()): ?>
                                <span>
                                    тел.
                                    <?php foreach ($row['phones'] as $contactPhoneIndex => $contactPhoneItem): ?>
                                        <?php if ($contactPhoneIndex > 0): ?>, <?php endif; ?><a href="tel:<?php echo e($contactPhoneItem['href']); ?>"><?php echo e($contactPhoneItem['label']); ?></a>
                                    <?php endforeach; ?>
                                </span>
                            <?php else: ?>
