...
$departmentDownloadItems = isset($departmentItem['download_items']) && is_array($departmentItem['download_items'])
    ...
    : array();
$departmentMetaSplitContacts = !empty($departmentItem['meta_split_contacts_row']);
...
<head>
    ...
    <style>
        ...
        .department-detail-meta__item--wide {
            grid-column: 1 / -1;
        }
        ...
        .department-detail-meta__value a:hover,
        .department-detail-meta__value a:focus-visible,
        .department-detail-source a:hover,
        .department-detail-source a:focus-visible {
            color: #c62b30;
        }

        .department-detail-meta__hint {
            display: block;
            margin-top: 8px;
            color: rgba(20, 53, 43, 0.82);
            font-size: 13px;
            font-weight: 500;
            line-height: 1.45;
        }

        .department-detail-meta__phones {
            display: grid;
            gap: 6px;
        }

        .department-detail-meta__phone-link {
        ...
        .department-detail-social-link-row {
            color: #14352b;
        }

        .department-detail-social-link-row a {
            color: #1f5f47;
            font-weight: 600;
            text-decoration: none;
        }

        .department-detail-social-link-row a:hover,
        .department-detail-social-link-row a:focus-visible {
            color: #c62b30;
    ...
    <div class="department-detail-layout container">
        ...
        <div class="department-detail-content">
            ...
            <div class="department-detail-meta" aria-label="Контактная информация отделения">
                ...
                <article class="department-detail-meta__item<?php echo $departmentMetaSplitContacts ? '' : ' department-detail-meta__item--wide'; ?>">
                    <span class="department-detail-meta__label">Телефон</span>
                    <span class="department-detail-meta__value department-detail-meta__phones">
                        <?php if (isset($departmentItem['phones']) && is_array($departmentItem['phones']) && $departmentItem['phones'] !== array()): ?>
                            <?php foreach ($departmentItem['phones'] as $departmentPhoneItem): ?>
                                <a class="department-detail-meta__phone-link" href="tel:<?php echo e($departmentPhoneItem['href']); ?>"><?php echo e($departmentPhoneItem['label']); ?></a>
                            <?php endforeach; ?>
                        <?php else: ?>
                            <a class="department-detail-meta__phone-link" href="tel:<?php echo e((string) $departmentItem['phone_href']); ?>"><?php echo e((string) $departmentItem['phone']); ?></a>
                        <?php endif; ?>
                    </span>
                </article>
                <?php if (!empty($departmentItem['extra_contacts']) && is_array($departmentItem['extra_contacts'])): ?>
                    <?php foreach ($departmentItem['extra_contacts'] as $extraContact): ?>
                        <?php if (empty($extraContact['label'])) continue; ?>
                        <?php $extraPhones = isset($extraContact['phones']) && is_array($extraContact['phones']) ? $extraContact['phones'] : array(); ?>
                        <article class="department-detail-meta__item<?php echo $departmentMetaSplitContacts ? '' : ' department-detail-meta__item--wide'; ?>">
                            <span class="department-detail-meta__label"><?php echo e((string) $extraContact['label']); ?></span>
                            <span class="department-detail-meta__value<?php echo $extraPhones !== array() ? ' department-detail-meta__phones' : ''; ?>">
                                <?php if ($extraPhones !== array()): ?>
                                    <?php foreach ($extraPhones as $extraPhone): ?>
                                        <a class="department-detail-meta__phone-link" href="tel:<?php echo e((string) ($extraPhone['href'] ?? '')); ?>"><?php echo e((string) ($extraPhone['label'] ?? '')); ?></a>
                                    <?php endforeach; ?>
                                <?php elseif (!empty($extraContact['value'])): ?>
                                    <?php echo e((string) $extraContact['value']); ?>
                                <?php endif; ?>
                                <?php if (!empty($extraContact['description'])): ?>
                                    <span class="department-detail-meta__hint"><?php echo e((string) $extraContact['description']); ?></span>
                                <?php endif; ?>
                            </span>
                        </article>
                    <?php endforeach; ?>
