...
bootstrapPublicPageVisibility($conn, '/listevents.php', 'Мероприятия');
...
$seoTitleMeta = 'Мероприятия ТЦСОН Железнодорожного района г. Гомеля' . $seoPageSuffix;
$seoDescriptionMeta = 'Мероприятия ТЦСОН Железнодорожного района г. Гомеля: встречи, акции, занятия и события для жителей района'
