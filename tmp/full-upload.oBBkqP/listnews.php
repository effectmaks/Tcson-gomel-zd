...
$archivePageTitle = 'Новости';
$archiveSectionTitle = 'Актуальные новости';
$archiveCurrentPath = '/listnews.php';
$archiveNewsUrl = '/listnews.php';
$archiveEventsUrl = '/listevents.php';
$seoPageSuffix = $page > 1 ? ' — страница ' . $page : '';
$seoTitleMeta = 'Новости ТЦСОН Железнодорожного района г. Гомеля' . $seoPageSuffix;
$seoDescriptionMeta = 'Последние новости ТЦСОН Железнодорожного района г. Гомеля: социальная поддержка, полезная информация и важные объявления'
...
<head>
    ...
    <title><?php echo htmlspecialchars($seoTitleMeta, ENT_QUOTES, 'UTF-8'); ?></title>
    <?php
            ...
            <div class="events-archive-intro__content">
                ...
                <div class="events-archive-toggle" aria-label="Переключение типа событий">
                    <div class="events-archive-toggle__shell">
                        <a class="events-archive-toggle__button is-active" href="<?php echo e($archiveNewsUrl); ?>">
                            <span class="events-archive-toggle__icon events-archive-toggle__icon--news" aria-hidden="true"></span>
                            <span>Новости</span>
                        </a>
                        <a class="events-archive-toggle__button" href="<?php echo e($archiveEventsUrl); ?>">
