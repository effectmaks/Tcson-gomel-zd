...
$staticEntries = array(
    ...
    array('path' => '/domestic-violence-prevention.php', 'lastmod' => date('Y-m-d', filemtime(__DIR__ . '/domestic-violence-prevention.php'))),
    array('path' => '/gossocpodderzhka-invalidov.php', 'lastmod' => date('Y-m-d', filemtime(__DIR__ . '/gossocpodderzhka-invalidov.php'))),
    array('path' => '/informatsiya.php', 'lastmod' => date('Y-m-d', filemtime(__DIR__ . '/informatsiya.php'))),
    array('path' => '/easy-language.php', 'lastmod' => date('Y-m-d', filemtime(__DIR__ . '/easy-language.php'))),
    array('path' => '/questions-answers.php', 'lastmod' => date('Y-m-d', filemtime(__DIR__ . '/questions-answers.php'))),
    array('path' => '/direct-phone-line.php', 'lastmod' => date('Y-m-d', filemtime(__DIR__ . '/direct-phone-line.php'))),
    array('path' => '/personal-reception.php', 'lastmod' => date('Y-m-d', filemtime(__DIR__ . '/personal-reception.php'))),
    array('path' => '/electronic-appeals.php', 'lastmod' => date('Y-m-d', filemtime(__DIR__ . '/electronic-appeals.php'))),
    array('path' => '/about.php', 'lastmod' => date('Y-m-d', filemtime(__DIR__ . '/about.php'))),
    array('path' => '/structure.php', 'lastmod' => date('Y-m-d', filemtime(__DIR__ . '/structure.php'))),
    array('path' => '/procedures.php', 'lastmod' => date('Y-m-d', filemtime(__DIR__ . '/procedures.php'))),
