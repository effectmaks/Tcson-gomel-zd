...
<head>
    ...
    <style>
        ...
        .structure-card--department .structure-card__icon {
            -webkit-mask: var(--structure-department-icon) no-repeat center / contain;
            mask: var(--structure-department-icon) no-repeat center / contain;
        }
                    ...
                    <div class="structure-org__branches">
                        ...
                        <div class="structure-org__column structure-org__column--departments">
                            ...
                            <article class="structure-card structure-card--department">
                                <span
                                    class="structure-card__icon"
                                    aria-hidden="true"
                                    style="--structure-department-icon: url('<?php echo e(getDepartmentIconPath($department['icon'])); ?>');"
                                ></span>
                                <div class="structure-card__body">
