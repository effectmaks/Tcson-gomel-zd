...
<?php endforeach; ?>
                ...
                <aside class="pension-panel" aria-labelledby="pension-doc-title">
                    <h2 class="pension-panel__title" id="pension-doc-title">Материал из задания</h2>
                    <p class="pension-panel__text">На странице размещена информация из переданного документа. Исходный файл доступен для скачивания в исходном формате.</p>
                    ...
                    <article class="pension-document">
                        ...
                        <div>
                            ...
                            <div class="pension-document__actions">
                                <a class="pension-button" href="<?php echo e($pageDocumentHref); ?>" download>Скачать</a>
                                <a class="pension-button pension-button--secondary" href="<?php echo e($pageOfficialHref); ?>" target="_blank" rel="noopener noreferrer">Перейти на сайт ФСЗН</a>
                            </div>
                        </div>
                    </article>
                </aside>
