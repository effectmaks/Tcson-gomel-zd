...
<head>
    ...
    <style>
        ...
        .homepage-contact-actions::before {
            content: "";
            position: absolute;
            top: -4px;
            left: 50%;
        ...
        .homepage-disability-support__shell::before {
            content: "";
            position: absolute;
            top: 34px;
            bottom: 34px;
        ...
        .homepage-disability-support__eyebrow {
            display: block;
            margin-bottom: 10px;
            color: #c62b30;
            font-size: 14px;
    ...
    <section class="homepage-section homepage-disability-support container" aria-labelledby="homepage-disability-support-title">
        <div class="homepage-disability-support__shell">
            <div class="homepage-disability-support__content">
                <span class="homepage-disability-support__eyebrow">Госсоцподдержка инвалидов</span>
                ...
                <p class="homepage-disability-support__text">На этой странице размещена краткая информация по основным мерам поддержки. Полный перечень условий и деталей доступен в прикрепленной памятке для скачивания.</p>
            </div>
